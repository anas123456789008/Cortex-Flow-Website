...
function DashboardPage() {
  ...
  const { kpis, monthly, categoryBreakdown } = useMemo(
    () => computeStats(currentMonthTxns),
    [currentMonthTxns],
  );
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          <div className="rounded-2xl border border-border bg-glass p-5 backdrop-blur-xl lg:col-span-2">
            <div className="mb-4 flex items-center justify-between">
              ...
              <div className="rounded-md border border-border bg-glass px-3 py-1 text-xs text-muted-foreground">
                Last 6 months
              </div>
            </div>
            <div className="h-72">
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          <div className="rounded-2xl border border-border bg-glass p-5 backdrop-blur-xl">
            <div className="mb-3 flex items-center justify-between">
              ...
              <Link to="/documents" className="text-xs text-violet hover:underline">
                View all
              </Link>
            </div>
            {recentDocs.length === 0 ? (
...
function KpiCard({
  ...
  return (
    <div className="group rounded-2xl glass p-5 glass-hover">
      ...
      <div className="mt-1 font-mono text-2xl font-bold animate-count">
...
function generateInsight(
  kpis: ReturnType<typeof computeStats>["kpis"],
