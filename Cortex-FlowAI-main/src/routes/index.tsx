  ...
  head: () => ({
    meta: [
      { title: "Cortex Flow — Turn Data Into Financial Wisdom" },
      {
        name: "description",
        content:
          "AI-powered personal finance: upload statements, chat with your data, and get personalized recommendations in plain English.",
      },
      ...
      <div className="relative z-10">
        <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/auth"
              className="rounded-lg gradient-violet px-4 py-2 text-sm font-semibold text-white transition hover:opacity-90 glow-violet"
            >
              Get started
            </Link>
          </div>
        ...
        <section className="mx-auto max-w-6xl px-6 pt-16 pb-20 text-center md:pt-28">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            Upload your statements, ask anything in plain English, and get clear, AI-driven insights
          ...
          <div className="mx-auto flex max-w-3xl items-start gap-4 rounded-2xl border border-emerald/30 bg-emerald/5 p-5 backdrop-blur-xl">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                Your data is protected with bank-level encryption, secure authentication, and
                automatic session management — built with Supabase security standards.
              </p>
            </div>
          </div>
        </section>
